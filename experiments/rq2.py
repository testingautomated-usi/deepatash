...
def preprare_the_figure(plot_data):
    tools = ["DeepHyperion", "DLFuzz", "DeepAtash"]
    fontsize = 20
    min_fontsize = 16
...
if __name__ == "__main__": 
    ...
    # Store
    create_the_table(mnist_data, file_name="RQ2-MNIST-dark-table")
    store_figure_to_paper_folder(mnist_figure, file_name="RQ2-MNIST-dark")


    mnist_data = load_data_from_folder("./data/mnist/target_cell_in_gray")
    mnist_figure = preprare_the_figure(mnist_data)

    # Store
    create_the_table(mnist_data, file_name="RQ2-MNIST-gray-table")
    store_figure_to_paper_folder(mnist_figure, file_name="RQ2-MNIST-gray")

    mnist_data = load_data_from_folder("./data/mnist/target_cell_in_white")
    mnist_figure = preprare_the_figure(mnist_data)

    # Store
    create_the_table(mnist_data, file_name="RQ2-MNIST-white-table")
    store_figure_to_paper_folder(mnist_figure, file_name="RQ2-MNIST-white")


    beamng_data = load_data_from_folder("./data/beamng/target_cell_in_dark")
