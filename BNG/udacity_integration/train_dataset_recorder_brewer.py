...
def run_sim(street_1: DecalRoad, folder):
    ...
    sim_data_collector = TrainingDataCollectorAndWriter(vehicle, beamng, street_1, cameras, folder)
...
if __name__ == '__main__':
    ...
    for i in range(0,10):
        ...
        run_sim(street, "test")
        destination_road = f"road_{i}.json"
       
        with open(destination_road, 'w') as f: 
            f.write(json.dumps(road.to_dict()))