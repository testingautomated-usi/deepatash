...
def load_data_from_folder(folder_name):
    ...
    """
    tracks = [f'training_recordings/{folder_name}']
    ...
    print("Validation dataset: " + str(len(X_valid)) + " elements")
    return X_train, X_valid, y_train, y_valid


def load_data_test(folder_name):
    ...
    print(f"{folder_name} dataset: " + str(len(X_test)) + " elements")
